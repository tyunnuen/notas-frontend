        ...
        notas.forEach(nota => {
            ...
            div.innerHTML = `
                ...
                <div style="margin-top: 10px; display: flex; gap: 10px;">
                    <button onclick="prepararEdicion(${nota.id}, '${nota.autor
                }', '${nota.contenido.replace(
                    /'/g,
                    "\\'"
                )}')" style="background: #ffa500; font-size: 12px; padding: 5px 10px;">Editar</button>
                    <button onclick="eliminarNota(${nota.id
                })" style="background: #dc3545; font-size: 12px; padding: 5px 10px;">Eliminar</button>
                </div>
            `
